(() => {
                ...
                ! function(s, r) {
                    ...
                    i = function() {
                        var t, e, n, i, o, s = '<svg width="44" height="60"><polyline points="30 10 10 30 30 50" stroke="rgba(255,255,255,0.5)" stroke-width="4"stroke-linecap="butt" fill="none" stroke-linejoin="round"/></svg>',
                            ...
                            k = function(t) {
                                t.stopPropagation ? t.stopPropagation() : t.cancelBubble = !0, F()
                            },
                            I = function(t) {
                            ...
                            T = function(t) {
                                if (!m && !p.multitouch) {
                                    ...
                                    40 < e.pageX - p.startX ? (m = !0, B()) : e.pageX - p.startX < -40 ? (m = !0, z()) : 100 < p.startY - e.pageY && F()
                                }
                            },
                            S = function() {
                        ...
                        function N(t, e) {
                            return !d && 0 <= t && t < e.length ? (D(e, l), A(t), !0) : t < 0 ? (l.animation && j("left"), !1) : t >= g.length ? (l.animation && j("right"), !1) : (P(f = t, (function() {
                                H(f), q(f)
                        ...
                        function H(t) {
                            t - f >= l.preload || P(t + 1, (function() {
                                H(t + 1)
                            }))
                        }

                        function q(t) {
                            f - t >= l.preload || P(t - 1, (function() {
                                q(t - 1)
                            }))
                        }
                        ...
                        return [].forEach || (Array.prototype.forEach = function(t, e) {
                                    ...
                                    function() {
                                        ...
                                        (t = U("div")).setAttribute("role", "dialog"), t.id = "baguetteBox-overlay", document.getElementsByTagName("body")[0].appendChild(t), (e = U("div")).id = "baguetteBox-slider", t.appendChild(e), (n = U("button")).setAttribute("type", "button"), n.id = "previous-button", n.setAttribute("aria-label", "Previous"), n.innerHTML = c.svg ? s : "&lt;", t.appendChild(n), (i = U("button")).setAttribute("type", "button"), i.id = "next-button", i.setAttribute("aria-label", "Next"), i.innerHTML = c.svg ? r : "&gt;", t.appendChild(i), (o = U("button")).setAttribute("type", "button"), o.id = "close-button", o.setAttribute("aria-label", "Close"), o.innerHTML = c.svg ? a : "&times;", t.appendChild(o), n.className = i.className = o.className = "baguetteBox-button",
                                            function() {
                                                ...
                                                V(t, "click", E), V(n, "click", _), V(i, "click", w), V(o, "click", k), V(e, "contextmenu", C), V(t, "touchstart", I, r), V(t, "touchmove", T, s), V(t, "touchend", S), V(document, "focus", L, !0)
                                            }()
                                    }(), O(l),
                                    function(t, e) {
                            ...
                            destroy: function() {
                                ! function() {
                                    ...
                                    W(t, "click", E), W(n, "click", _), W(i, "click", w), W(o, "click", k), W(e, "contextmenu", C), W(t, "touchstart", I, r), W(t, "touchmove", T, s), W(t, "touchend", S), W(document, "focus", L, !0)
                                }(),
                                function() {
    ...
    n.n = t => {
        ...
        }, u.exports = c, u.exports.TinyEmitter = c;
        var h = u.exports,
            f = "undefined" != typeof Element ? Element.prototype : {},
            d = f.matches || f.matchesSelector || f.webkitMatchesSelector || f.mozMatchesSelector || f.msMatchesSelector || f.oMatchesSelector,
            p = function(t, e) {
        ...
        var g = function() {
            ...
            b = function() {
                function t(n, i, o, s, r) {
                    e(this, t), this.id = r, this.left = n, this.top = i, this.width = o, this.height = s
                }
                return o(t, null, [{
                    key: "intersects",
                    value: function(t, e) {
            ...
            w = function() {
                function t(n, i) {
                    e(this, t), _ += 1, this.id = _, this.element = n, this.isRTL = i, this.isVisible = !0, this.isHidden = !1
                }
                return o(t, [{
                    key: "show",
                    value: function() {
                        this.isVisible = !0, this.element.classList.remove(E.HIDDEN), this.element.classList.add(E.VISIBLE), this.element.removeAttribute("aria-hidden")
                    }
                }, {
                    key: "hide",
                    value: function() {
                        this.isVisible = !1, this.element.classList.remove(E.VISIBLE), this.element.classList.add(E.HIDDEN), this.element.setAttribute("aria-hidden", !0)
                    }
                }, {
                    key: "init",
                    value: function() {
                        this.addClasses([E.SHUFFLE_ITEM, E.VISIBLE]), this.applyCss(t.Css.INITIAL), this.applyCss(this.isRTL ? t.Css.DIRECTION.rtl : t.Css.DIRECTION.ltr), this.scale = t.Scale.VISIBLE, this.point = new g
                    }
                }, {
                    key: "addClasses",
                    value: function(t) {
                    ...
                    key: "dispose",
                    value: function() {
                        this.removeClasses([E.HIDDEN, E.VISIBLE, E.SHUFFLE_ITEM]), this.element.removeAttribute("style"), this.element = null
                    }
                }]), t
            }();
        w.Css = {
        ...
        function T(t, e) {
            var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : window.getComputedStyle(t, null),
                i = y(n[e]);
            return I() || "width" !== e ? I() || "height" !== e || (i += y(n.paddingTop) + y(n.paddingBottom) + y(n.borderTopWidth) + y(n.borderBottomWidth)) : i += y(n.paddingLeft) + y(n.paddingRight) + y(n.borderLeftWidth) + y(n.borderRightWidth), i
        }
        var S = {
            reverse: !1,
            by: null,
        ...
        function D(t) {
            return !!L[t] && (L[t].element.removeEventListener(O, L[t].listener), L[t] = null, !0)
        }
        ...
        function A(t, e) {
            ...
            return t.addEventListener(O, i), L[n] = {
                element: t,
                listener: i
            }, n
        }
        ...
        var j = 0,
            R = function(t) {
                ...
                function i(t) {
                    ...
                    e(this, i), (o = n.call(this)).options = Object.assign({}, i.options, s), o.options.delimeter && (o.options.delimiter = o.options.delimeter), o.lastSort = {}, o.group = i.ALL_ITEMS, o.lastFilter = i.ALL_ITEMS, o.isEnabled = !0, o.isDestroyed = !1, o.isInitialized = !1, o._transitions = [], o.isTransitioning = !1, o._queue = [];
                    var r = o._getElementOption(t);
                    if (!r) throw new TypeError("Shuffle needs to be initialized with an element.");
                    return o.element = r, o.id = "shuffle_" + j, j += 1, o._init(), o.isInitialized = !0, o
                }
                return o(i, [{
                    key: "_init",
                    value: function() {
                    ...
                    value: function(t, e) {
                        var n = this,
                            o = [],
                            s = [];
                        return t === i.ALL_ITEMS ? o = e : e.forEach((function(e) {
                            n._doesPassFilter(t, e.element) ? o.push(e) : s.push(e)
                        })), {
                            visible: o,
                            hidden: s
                        }
                    ...
                    value: function(t, e) {
                        ...
                        var n = e.getAttribute("data-" + i.FILTER_ATTRIBUTE_KEY),
                            o = this.options.delimiter ? n.split(this.options.delimiter) : JSON.parse(n);

                        function s(t) {
                            return o.includes(t)
                        }
                        return Array.isArray(t) ? this.options.filterMode === i.FilterMode.ANY ? t.some(s) : t.every(s) : o.includes(t)
                    }
                }, {
                    ...
                    value: function(t) {
                        ...
                        t.forEach((function(t, o) {
                            ...
                            if (g.equals(t.point, n[o]) && !t.isHidden) return t.applyCss(w.Css.VISIBLE.before), void s();
                            t.point = n[o], t.scale = w.Scale.VISIBLE, t.isHidden = !1;
                    ...
                    value: function(t) {
                        return function(t) {
                            for (var e = t.itemSize, n = t.positions, i = t.gridSize, o = t.total, s = t.threshold, r = t.buffer, a = F(e.width, i, o, s), l = P(n, a, o), u = z(l, r), c = new g(i * u, l[u]), h = l[u] + e.height, f = 0; f < a; f++) n[u + f] = h;
                            return c
                        }({
                            itemSize: t,
                    ...
                    value: function() {
                        ...
                        e.forEach((function(e) {
                            ...
                            if (e.isHidden) return e.applyCss(w.Css.HIDDEN.before), void i();
                    ...
                    value: function(t) {
                        ...
                        this.isTransitioning = !0,
                            function(t, e, n) {
                                n || ("function" == typeof e ? (n = e, e = null) : n = v);
                                var i = t && t.length;
                                if (!i) return n(null, []);
                                var o = !1,
                                    s = new Array(i);
                    ...
                    value: function(t) {
                        ...
                        var i = C(this._mergeNewItems(n), this.lastSort),
                            ...
                            r = function(t) {
                                t.scale = w.Scale.HIDDEN, t.isHidden = !0, t.applyCss(w.Css.HIDDEN.before), t.applyCss(w.Css.HIDDEN.after)
                            },
                    ...
                    value: function(t) {
                        ...
                        if (t.length) {
                            ...
                            this._toggleFilterClasses({
                                ...
                                e._disposeItems(o), n.forEach((function(t) {
        ...
        R.ShuffleItem = w, R.ALL_ITEMS = "all", R.FILTER_ATTRIBUTE_KEY = "groups", R.EventType = {
            LAYOUT: "shuffle:layout",
            REMOVED: "shuffle:removed"
        }, R.Classes = E, R.FilterMode = {
            ANY: "any",
            ALL: "all"
        }, R.options = {
            group: R.ALL_ITEMS,
            ...
            isRTL: !1,
            roundTransforms: !0
        }, R.Point = g, R.Rect = b, R.__sorter = C, R.__getColumnSpan = F, R.__getAvailablePositions = P, R.__getShortColumn = z, R.__getCenteredPositions = B;
        const H = R;
        ...
        const V = function(e, n, i) {
            ...
            if (o) {
                var s = new H(o, function(e) {
                        for (var n = 1; n < arguments.length; n++) {
                            var i = null != arguments[n] ? arguments[n] : {};
                            n % 2 ? q(Object(i), !0).forEach((function(n) {
                                t(e, n, i[n])
                ...
                r.forEach((function(t) {
                    t.addEventListener("click", (function(t) {
                        t.preventDefault();
                        for (var e = 0; e < r.length; e++) r[e].classList.remove("active");
        ...
        document.addEventListener("DOMContentLoaded", (function() {
            ...
            }), X(".gallery_masonry-item"), X(".gallery_grid")
        }))
    })()
})();